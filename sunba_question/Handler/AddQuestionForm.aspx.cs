...
public partial class Handler_AddQuestionForm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string fillformname = LogInfo.name;
            string empid = LogInfo.mGuid;
            string orgid = LogInfo.orgcd;
            string orgnization = LogInfo.orgname;
